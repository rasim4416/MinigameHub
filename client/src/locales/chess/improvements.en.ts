export const IMPROVEMENTS_EN: Record<string, string[]> = {
  "miner": [
    "Earn 2 gold every 2 turns (was every 3). Infinitely stackable."
  ],
  "alternative": [
  ...
  "thief": [
    "2% chance per Thief stack to gain 50 gold at end of turn.",
    "5% chance per Thief stack to gain 50 gold at end of turn.",
    "10% chance per Thief stack to gain 50 gold at end of turn."
  ],
  "king-of-the-hill": [
    "Each of your pieces on d4/d5/e4/e5 earns 2 gold per turn."
  ],
  "jew": [
    "When the enemy captures your pawns, you gain 3 gold per captured pawn.",
  ...
  "i-am-danger": [
    "Each time you give check to the enemy king, gain 5 gold (per stack)."
  ],
  "bloodlust": [
    "Every 3 enemy pieces you capture, gain 1 bonus augment pick.",
